...
import { Newspaper, ExternalLink, X, Clock, Tag } from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-lg max-w-2xl w-full p-6 relative">
        ...
        <div className="mb-4">
          ...
          <h3 className="text-[#4B0082] font-bold text-2xl mb-2">
            {news.title}
          </h3>
          ...
          {newsItems.map((news) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <h3 className="text-[#4B0082] font-bold text-lg mb-2 line-clamp-2">
                  {news.title}
                </h3>
                <div className="flex items-center justify-between">
                  ...
                  <button 
                    className="text-[#4B0082] hover:text-[#3A006B] transition-colors"
